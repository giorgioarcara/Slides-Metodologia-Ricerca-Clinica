...
## A complicare la cose
![](Figures/triangle.png){width="20%" fig-align="center"}

- Anche se un effetto è **vero** statisticamente non tutti gli studi mostreranno quell'effetto
\pause

- Anche se un effetto **non è vero**, statisticamente alcuni studi potrebbero mostrare quell'effetto.

(c'entra il fatto che lavoriamo su _campioni_ estratti da _popolazioni_)
...
## Eterogeneità: approfondimenti

Per un approfondimento si veda \href{https://pmc.ncbi.nlm.nih.gov/articles/PMC12326561/}{\underline{\textbf{Choi et al., 2025}}}
...
## Delphi in neuropsicologia o psicologia
